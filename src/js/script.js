...
/* ==========================================================================
  ...
  function theme() {
    ...
    function dark() {
      ...
      localStorage.setItem('biomadeira_attila_theme', 'dark');
      toggleText.text(toggle.attr('data-dark'));
    }

    function light() {
      html.removeClass('theme-dark').addClass('theme-light');
      localStorage.setItem('biomadeira_attila_theme', 'light');
      toggleText.text(toggle.attr('data-light'));
    }

    switch (localStorage.getItem('biomadeira_attila_theme')) {
      case 'dark':
        dark();
      break;
      case 'light':
